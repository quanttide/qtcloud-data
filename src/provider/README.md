...
```powershell
$env:PORT = "8080"
$env:SPEC_DIR = "D:\1qt\qt-cloud\src\cli\.quanttide\data\spec"
$env:DATA_ROOT = "D:\1qt\qt-cloud\src\cli\.quanttide\data"
$env:PIPELINE_WORK_ROOT = "D:\1qt\qt-cloud\.codex-run\provider-work"
...
Invoke-RestMethod -Method Post `
  ...
  -Body (@{
    customer_id = "demo"
    input_path = "D:\1qt\qt-cloud\.codex-run\demo-raw.csv"
  } | ConvertTo-Json)
```
