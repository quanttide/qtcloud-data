...
### 修复
- 蓝图详情页移除硬编码 mock（客户画像/问卷旧案例），改为从 seed 加载（量潮科技数字化案例）
- 传输页提供商列表与总览同源（seed_dashboard.json）
- 需求数据修正：量潮科技数字化为完整项目案例，议事决议数据需求点为项目下需求（移除伪需求，展示项目归属）

## [studio/v0.1.0-beta.3] - 2026-08-08

### 变更
- seed 数据与 qtdata 案例对齐（前后台同套数据）：量潮科技数字化 · 议事决议数据需求点
  - 需求：议事决议数据需求点 / 历史周会批量整理
  - 蓝图：决议提取与标准化 / 治理与周会报告
  - 契约：决议档案 / 治理视图 / 周会决议汇总
  - 管道：决议导入 / 治理报告
  - 执行：第33周示例上线完成 / 治理视图生成 / 历史周会批量整理进行中
